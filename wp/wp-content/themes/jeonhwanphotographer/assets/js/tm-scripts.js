function include(scriptUrl) {
    var path = '/wp-content/themes/jeonhwanphotographer/assets/';
    document.write('<script src="' + path + scriptUrl + '"></script>');
}

function includeDirect(scriptUrl) {
...
(function ($) {
    function include(url) {
        var path = '/wp-content/themes/jeonhwanphotographer/assets/js/';
...
(function ($) {
    ...
    if (o) {
        //includeDirect('//maps.google.com/maps/api/js?sensor=false');
...
$(document).ready(function () {
    var path = '/wp-content/themes/jeonhwanphotographer/assets/tm/css/';
    $('head').append('<link rel="stylesheet" href="'+ path + '/tm_docs.css" type="text/css" media="screen"><link href="'+path+'/tm_panel.css" rel="stylesheet">');
